                   ...
                   return (
                     ...
                     >
                       ...
                       {(isVisible && showResult) ? (
                         ...
                         <div className={`w-0.5 h-0.5 rounded-full transition-all duration-1000 ${isAnalyzing ? 'bg-fuchsia-500 shadow-[0_0_8px_rgba(217,70,239,1)] animate-pulse' : 'bg-zinc-900 opacity-30'}`} />
                       )}
                     </div>
                   );
                 })}

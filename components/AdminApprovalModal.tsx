    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/90 backdrop-blur-md" dir="ltr">
      ...
      >
        <div className="p-6 bg-zinc-950/95 rounded-[23px] text-center relative overflow-hidden">
          ...
          <div className="relative mb-6 p-4 rounded-2xl bg-black/60 border border-cyan-500/20 shadow-[inset_0_0_15px_rgba(6,182,212,0.05)]">
            ...
            <div className="text-3xl font-mono font-black text-cyan-400 drop-shadow-[0_0_10px_rgba(6,182,212,0.5)] tracking-wider">
              {formatTime(timeLeft)}
            </div>
            ...
            <div className="mt-3.5 h-1.5 w-full bg-zinc-900 rounded-full overflow-hidden p-[1px]">
              <div
                className="h-full bg-cyan-500 rounded-full transition-all duration-1000 ease-linear shadow-[0_0_8px_#06b6d4]"
